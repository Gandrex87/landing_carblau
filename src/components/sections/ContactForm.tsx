...
export function ContactForm() {
  ...
  return (
    <section id="contact" className="relative py-24 overflow-hidden">
      {/* Spotlight central sutil */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(243,235,221,0.04) 0%, transparent 70%)",
        }}
      />
      {/* Orbe sage (top-left) */}
      <div
        className="absolute top-0 left-0 w-[650px] h-[650px] rounded-full blur-[140px] -ml-48 -mt-40 pointer-events-none"
        style={{ backgroundColor: "rgba(173, 212, 211, 0.14)" }}
      />
      {/* Orbe teal (bottom-right) */}
      <div
        className="absolute bottom-0 right-0 w-[550px] h-[550px] rounded-full blur-[130px] -mr-32 -mb-40 pointer-events-none"
        style={{ backgroundColor: "rgba(125, 191, 195, 0.20)" }}
      />
      {/* Acento cálido (top-right pequeño) */}
      <div
        className="absolute top-20 right-1/4 w-[280px] h-[280px] rounded-full blur-[100px] pointer-events-none"
        style={{ backgroundColor: "rgba(255, 173, 100, 0.20)" }}
      />
